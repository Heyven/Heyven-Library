...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", employeeName=" + employeeName + ", employeeNumber=" + employeeNumber
				+ ", employeePhoto=" + employeePhoto + ", employeeSex=" + employeeSex + ", employeeBirthday="
				+ employeeBirthday + ", employeePhone=" + employeePhone + ", employeeEmail=" + employeeEmail
				+ ", employeeEducation=" + employeeEducation + ", departmentName=" + departmentName + ", employeeJob="
				+ employeeJob + ", gradeGrade=" + gradeGrade + ", basicPay=" + basicPay + ", inductionTime="
				+ inductionTime + ", state=" + state + ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", creator=" + creator + "]";
	}
