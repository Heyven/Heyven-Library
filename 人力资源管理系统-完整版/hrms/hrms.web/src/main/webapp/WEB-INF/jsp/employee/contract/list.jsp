...
<script type="text/javascript" src="js/employee-contract.js"></script>
  <div class="panel admin-panel">
    <div class="panel-head"><strong class="icon-reorder"> 合同列表</strong> </div>
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
          ...
          <a href="javascript:void(0)" class="button border-main icon-search" onclick="EmployeeContract.events.search('first')" > 搜索</a>
          </li>
      </ul>
    </div>
