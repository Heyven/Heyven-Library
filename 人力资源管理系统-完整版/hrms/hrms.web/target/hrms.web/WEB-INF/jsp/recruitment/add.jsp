...
<div class="panel-head" id="add">
	<strong><span class="icon-pencil-square-o"></span>添加招聘</strong>
</div>
<div class="body-content">
	<form method="post" name="insertRecruitmentForm" class="form-x">
		...
		<div class="form-group">
			...
			<div class="field">
				<textarea rows="5" cols="50" name="jobRequirements" data-validate="required:请输入任职要求"></textarea>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="field">
				<textarea rows="5" cols="50" name="jobContent" data-validate="required:请输入工作内容"></textarea>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input w50" value="2" name="recruitmentNumber" data-validate="required:请输入招聘人数"/>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="field">
				<input type="text" name="companyAddress" data-validate="required:请输入公司地址"/>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
