...
<div class="panel-head" id="add">
	<strong><span class="icon-pencil-square-o"></span>添加应聘</strong>
</div>
<div class="body-content">
	<form method="post" name="insertApplyForm" class="form-x">
		<div class="form-group">
			<div class="label">
				<label>应聘人姓名: </label>
			</div>
			<div class="field">
				<input type="text" onchange="Apply.events.exists(this);" class="input w50" name="applyName" data-validate="required:请输入应聘人姓名"/>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="field">
					...
					<input id="applyBirthday" name="applyBirthday" type="hidden">
		...
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input w50" name="applyPhone" data-validate="required:请输入联系电话"/>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="field">
				<input type="text" class="input w50" name="applyEmail" data-validate="required:请输入邮箱"/>
				<div class="tips"></div>
			</div>
		</div>
		<div class="form-group">
